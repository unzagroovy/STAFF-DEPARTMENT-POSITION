...
public class ParsingClass {
    public static void main(String[] args) {
        try {
            ...
            Path currentRelativePath = Paths.get("src/main/java/com/example/");
            String s = currentRelativePath.toAbsolutePath().toString()
                    + "";
            System.out.println("Current absolute path is: " + s);
            // Parse the Java source file
            ParseResult<CompilationUnit> parseResult = javaParser
                    .parse(new FileInputStream(s + "/StaffDeptPosition.java"));
            CompilationUnit compilationUnit = parseResult.getResult().orElse(null);

            Optional<ClassOrInterfaceDeclaration> mainClass = compilationUnit.getClassByName("StaffDeptPosition");
    ...
    //   new FileInputStream("src/main/java/com/example/StaffDeptPosition.java"));
    //   CompilationUnit compilationUnit = parseResult.getResult().orElse(null);
